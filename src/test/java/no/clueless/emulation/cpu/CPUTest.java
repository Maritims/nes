...
class CPUTest {
    ...
    void ADC_should_return_300_when_adding_150_to_150() {
        ...
        var cpu            = new CPU(bus, new UnsignedByte(150), UnsignedByte.ZERO, UnsignedByte.ZERO, statusRegister);
    ...
    void AND_should_yield_1_when_both_operands_are_1() {
        ...
        var address        = new UnsignedWord(0x1234);
        var statusRegister = new StatusRegister();
        var cpu            = new CPU(bus, UnsignedByte.ONE, UnsignedByte.ZERO, UnsignedByte.ZERO, statusRegister);
    ...
    void ASL_should_shift_bits_to_the_left() {
        ...
        var bus            = new RAM();
        var statusRegister = new StatusRegister();
        var cpu            = new CPU(bus, UnsignedByte.MAX_VALUE, mock(), mock(), statusRegister);
    ...
    void EOR_should_return_0_when_both_operands_are_0() {
        ...
        var cpu = new CPU(bus, UnsignedByte.ZERO, UnsignedByte.ZERO, UnsignedByte.ZERO, statusRegister);
    ...
    void EOR_should_return_0_when_both_operands_are_1() {
        ...
        var address        = new UnsignedWord(0x1234);
        var statusRegister = new StatusRegister();
        var cpu            = new CPU(bus, UnsignedByte.ONE, UnsignedByte.ONE, UnsignedByte.ONE, statusRegister);
    ...
    void LSR_should_shift_bits_to_the_right() {
        ...
        var bus            = new RAM();
        var statusRegister = new StatusRegister();
        var cpu            = new CPU(bus, UnsignedByte.ONE, mock(), mock(), statusRegister);
    ...
    void ROL_should_read_from_accumulator_when_address_is_null() {
        var bus = spy(new RAM());
        var cpu = new CPU(bus, UnsignedByte.MAX_VALUE, mock(), mock(), mock());
    ...
    @Test
    void addressImmediate_should_increment_programCounter_and_return_the_original_programCounter() {
        // arrange
        var bus                       = new RAM();
        var cpu                       = new CPU(bus);
        var originalProgramCounter    = cpu.getProgramCounter();
        var incrementedProgramCounter = originalProgramCounter.increment();

        // act
        var actual = cpu.addressImmediate();

        // assert
        assertEquals(originalProgramCounter, actual);
        assertEquals(incrementedProgramCounter, cpu.getProgramCounter());
    }

    @Test
    void addressAbsolute_should_read_twice_from_the_bus_using_programCounter_and_increment_programCounter_by_2() {
        // arrange
        var bus                       = spy(new RAM());
        var cpu                       = new CPU(bus);
        var incrementedProgramCounter = cpu.getProgramCounter().increment().increment();
        var low                       = new UnsignedByte(0x34);
        var high                      = new UnsignedByte(0x12);
        var expected                  = new UnsignedWord(0x1234);
        bus.write(cpu.getProgramCounter(), low);
        bus.write(cpu.getProgramCounter().increment(), high);

        // act
        var actual = cpu.addressAbsolute();
