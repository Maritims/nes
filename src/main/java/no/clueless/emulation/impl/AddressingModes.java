...
public enum AddressingModes implements AddressingModeFunction<Cpu6502> {
    IMM(new Immediate()),
    ABS(new Absolute()),
    ABX(new AbsoluteWithRegister(Cpu6502::getX)),
    ABY(new AbsoluteWithRegister(Cpu6502::getY)),
    ZP0(new ZeroPage()),
    ZPX(new ZeroPageWithRegister(Cpu6502::getX)),
    ZPY(new ZeroPageWithRegister(Cpu6502::getY)),
    IND(new Indirect()),
    IZX(new IndirectX()),
    IZY(new IndirectY()),
    REL(new Relative()),
