...
public class InstructionTable {
    ...
    public static final Instruction[] INSTRUCTIONS = new Instruction[]{
            i(BRK, IMP, 0), i(ORA, IZX, 0), i(JAM, IMP, 0), i(SLO, IZX, 0), i(NOP, ZP0, 0), i(ORA, ZP0, 0), i(ASL, ZP0, 0), i(SLO, ZP0, 0), i(PHP, IMP, 0), i(ORA, IMM, 0), i(ASL, IMP, 0), i(ANC, IMM, 0), i(NOP, ABS, 0), i(ORA, ABS, 0), i(ASL, ABS, 0), i(SLO, ABS, 0),
            ...
            i(JSR, ABS, 0), i(AND, IZX, 0), i(JAM, IMP, 0), i(RLA, IZX, 0), i(BIT, ZP0, 0), i(AND, ZP0, 0), i(ROL, ZP0, 0), i(RLA, ZP0, 0), i(PLP, IMP, 0), i(AND, IMM, 0), i(ROL, IMP, 0), i(ANC, IMM, 0), i(BIT, ABS, 0), i(AND, ABS, 0), i(ROL, ABS, 0), i(RLA, ABS, 0),
            ...
            i(CPY, IMM, 0), i(CMP, IZX, 0), i(NOP, IMM, 0), i(DCP, IZX, 0), i(CPY, ZP0, 0), i(CMP, ZP0, 0), i(DEC, ZP0, 0), i(DCP, ZP0, 0), i(INY, IMP, 0), i(CMP, IMM, 0), i(DEX, IMP, 0), i(SBX, IMM, 0), i(CPY, ABS, 0), i(CMP, ABS, 0), i(DEC, ABS, 0), i(DCP, ABS, 0),
            i(BNE, REL, 0), i(CMP, IZY, 0), i(JAM, IMP, 0), i(DCP, IZY, 0), i(NOP, ZPX, 0), i(CMP, ZPX, 0), i(DEC, ZPX, 0), i(DCP, ZPX, 0), i(CLD, IMP, 0), i(CMP, ABY, 0), i(NOP, IMP, 0), i(DCP, ABY, 0), i(NOP, ABX, 0), i(CMP, ABX, 0), i(DEC, ABX, 0), i(DCP, ABX, 0),
